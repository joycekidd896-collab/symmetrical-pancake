...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    } else if (!hashError) setError("This password reset link is missing or expired. Request a new one.");
  }, []);
