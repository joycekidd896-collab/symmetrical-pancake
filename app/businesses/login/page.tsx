...
export default function MerchantLoginPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "signup" && !data.access_token) { setMessage("Account created! Check your email if confirmation is required, then sign in."); return; }
