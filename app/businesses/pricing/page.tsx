  ...
  return (
    <main className="queen-page">
      ...
      <section className="pricing-bottom">
        <div><div className="section-kicker">♛ READY TO GROW?</div><h2>Put your business in front of more shoppers.</h2><p>Coupon Queen keeps plan selection and billing connected to the same production merchant records used by your dashboard.</p></div>
