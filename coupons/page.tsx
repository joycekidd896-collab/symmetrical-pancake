...
export default function CouponsPage() {
  ...
  const filteredCoupons = useMemo(() => {
    ...
    return coupons.filter((coupon) => {
      ...
      const matchesQuery =
        !normalizedQuery ||
        `${coupon.title} ${coupon.business} ${coupon.category} ${coupon.location}`
          .toLowerCase()
    ...
    <main className="queen-page">
      <header className="site-header">
        ...
        <nav aria-label="Main navigation">
          <Link href="/coupons" aria-current="page">Coupons</Link>
      ...
      <section className="benefits-section">
        <div className="section-heading">
          ...
          <p>
            Search the royal collection, choose a category, and discover your next favorite deal.
          </p>
        </div>
        ...
        <div className="coupon-results-bar">
          <span><strong>{filteredCoupons.length}</strong> royal {filteredCoupons.length === 1 ? "deal" : "deals"} found</span>
          {(query || activeCategory !== "All Deals") && (
            <button
              type="button"
        ...
        {filteredCoupons.length === 0 && (
          <div className="empty-coupon-state">
            ...
            <p>Try another search or return to the full royal collection.</p>
            <button
              type="button"
